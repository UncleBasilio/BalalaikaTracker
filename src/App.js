...
function App() {
  ...
  const startButton = <Button variant="secondary" onClick={startTimer}>Start</Button>;
  const stopButton = <Button variant="success" onClick={stopTimer}>Stop</Button>;
  ...
  return <div>{startTime ? stopButton : startButton}<Timer />{JSON.stringify(stats)}</div>;
}
